		...
		return (
			<main className={classes.LoginScreen}>
				<div className={classes.LoginScreenFormArea}>
					...
					<p className={classes.LoginScreenFooter}>
						Copyright &copy; 2018 Recombee
					</p>
				</div>

				<div className={classes.LoginScreenMessageArea}>
					<div className={classes.LoginScreenMessageWrapper}>
						<h2 className={classes.MessageHeadline}>
							<span>Artifical Intelligence Powered</span>
						...
						<p className={classes.Message}>
							"Recombee's recommendation solution is incredible. Our ecommerce
							platform can recommend products with much more intelligence for
							our customers. The support is also fantastic!"
						</p>

						<div className={classes.MessageCaption}>
							<img
								className={classes.MessageCaptionImage}
								src={MessageUserIcon}
								alt="User Icon"
							/>
							<div className={classes.MessageCaptionText}>
								<p>Nicholas Blicker Larson</p>
								<p className={classes.MessageCaptionTitle}>
									CEO at{' '}
									<span className={classes.Highlighted}>Design Group</span>
								</p>
							</div>
						</div>
					</div>
